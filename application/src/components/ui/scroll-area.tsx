  ...
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ...
    class名称={cn(
      ...
      orientation === "vertical" &&
        "h-full w-3.5 border-l border-l-transparent p-[3px]",
      orientation === "horizontal" &&
        "h-3.5 flex-col border-t border-t-transparent p-[3px]",
      class名称
    )}
    {...props}
  >
    <ScrollAreaPrimitive.ScrollAreaThumb 
      class名称="relative flex-1 rounded-full bg-gray-400 hover:bg-gray-600 transition-colors opacity-100 min-h-[40px]" 
    />
  </ScrollAreaPrimitive.ScrollAreaScrollbar>
))
