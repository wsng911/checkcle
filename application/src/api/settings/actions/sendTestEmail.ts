...
export const sendTest邮箱 = async (data: any): Promise<设置ApiResponse> => {
  console.log('sendTest邮箱 function called with data:', data);
  ...
  try {
    ...
    console.log('邮箱 send simulation completed');
    ...
    console.error('Error in sendTest邮箱 function:', error);
    return {
      status: 200,
      json: { 
        success: false, 
